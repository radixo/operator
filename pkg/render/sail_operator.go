...
type SailOperatorConfig struct {
	ServiceMesh *operatorv1.ServiceMesh
}

type sailOperatorComponent struct {
	cfg *SailOperatorConfig
}
...
func (s *sailOperatorComponent) ResolveImages(is *operatorv1.ImageSet) error {
	panic("not implemented") // TODO: Implement
}

// Objects returns the lists of objects in this component that should be created and/or deleted during
// rendering.
func (s *sailOperatorComponent) Objects() (objsToCreate []client.Object, objsToDelete []client.Object) {
	panic("not implemented") // TODO: Implement
}

// Ready returns true if the component is ready to be created.
func (s *sailOperatorComponent) Ready() bool {
	panic("not implemented") // TODO: Implement
}
...
func (s *sailOperatorComponent) SupportedOSType() rmeta.OSType {
	panic("not implemented") // TODO: Implement
}

func SailOperatorComponent(cfg *SailOperatorConfig) Component {
	return &sailOperatorComponent{cfg}
}
